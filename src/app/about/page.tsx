      ...
      <div className="bg-white rounded-2xl border border-gray-100 p-6 md:p-8 flex flex-col md:flex-row gap-6 items-center mb-10">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-3 leading-relaxed">
            {t(
              'educator, educator और content creator। 1.1 Million+ subscribers के साथ YouTube पर UPSC, NEET, RAS, LDC की तैयारी करवाते हैं। "I know that I don\'t know" — यही हमारी philosophy है। सीखना कभी नहीं रुकता।',
              'educator, educator and content creator. Teaching UPSC, NEET, RAS, LDC preparation on YouTube with 1.1 Million+ subscribers. "I know that I don\'t know" — this is our philosophy. Learning never stops.'
            )}
          </p>
