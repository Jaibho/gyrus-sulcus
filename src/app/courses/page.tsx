...
const IOS_URL = 'https://apps.apple.com/in/app/gyrus-sulcus-app/id6742221489'
...
export default function CoursesPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10">
      ...
      {/* Get the app */}
      <div id="get-app" className="mt-12 rounded-2xl bg-gradient-to-r from-gray-900 to-gray-800 text-white p-8 text-center scroll-mt-24">
        ...
        <div className="mt-5 flex flex-wrap gap-3 justify-center">
          <a href={PLAY_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-gray-900 font-semibold rounded-xl hover:bg-gray-100 transition-colors">
            {t('Android — Google Play', 'Android — Google Play')} <ExternalLink size={16} />
          </a>
          <a href={IOS_URL} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-gray-900 font-semibold rounded-xl hover:bg-gray-100 transition-colors">
            {t('iOS — App Store', 'iOS — App Store')} <ExternalLink size={16} />
          </a>
        </div>
      </div>
